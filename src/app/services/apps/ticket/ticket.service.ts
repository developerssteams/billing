...
export class TicketService {
  ...
  public users = [
    { id: 1, name: 'Alice', photo: '/assets/images/profile/user-1.webp' },
    { id: 2, name: 'Jonathan', photo: '/assets/images/profile/user-2.webp' },
    { id: 3, name: 'Smith', photo: '/assets/images/profile/user-3.webp' },
    { id: 4, name: 'Vincent', photo: '/assets/images/profile/user-4.webp' },
    { id: 5, name: 'Chris', photo: '/assets/images/profile/user-5.webp' },
  ];
  ...
  addTicket(ticket: TicketElement): void {
    ...
    const newTicket: TicketElement = {
      ...
      imgSrc: '/assets/images/profile/user-1.webp',
      status: 'open',
